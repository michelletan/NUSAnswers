                ...
                <div class="card">
                    ...
                    <div class="post-footer">
                        <div class="row center-block">
                            ...
                            <?php } ?>
                            <a class="col-md-2 col-lg-2 text-center" onclick="share('/question/<?php echo $data["question_friendly_url"]?>')"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Share</a>
                        </div>
                    </div>
                </div>
